...
Scenario: Create products - green path
	...
	| Name   | Description   | Price    | Retail   | Cost   | Length   | Width   | Height   | Weight   | ShippingType   | Sku   | Barcode   | TrackInventory   | OutOfStockRule   |
	| <Name> | <Description> | <Pricce> | <Retail> | <Cost> | <Length> | <Width> | <Height> | <Weigth> | <ShippingType> | <Sku> | <Barcode> | <TrackInventory> | <OutOfStockRule> |
...
Examples: 
	| Name | Description     | Price | Retail | Cost | Length | Width | Height | Weight | ShippingType    | Sku      | Barcode       | TrackInventory | OutOfStockRule  |
	| DDD  | DDD Description | 100   | 120    | 80   | 1      | 2     | 3      | 4      | ShipSeparately  | ddd-book | 1234567890111 | True           | Remove          |
...
Examples: 
	| Name | Description     | Price | Retail | Cost | Length | Width | Height | Weight | ShippingType    | Sku      | Barcode       | TrackInventory | OutOfStockRule   | Comment                 |
	| DDD  | DDD Description | 100   | 120    | 80   | 1      | 2     | 3      | 4      | Ship Separately | ddd-book | 1234567890111 | Yes            | Remove           | Invalid ShippingType    |
